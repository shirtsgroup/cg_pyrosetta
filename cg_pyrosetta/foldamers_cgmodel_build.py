...
def get_monomer_internal_coordinates(cgmodel, monomer_type):
    ...
    for torsion in cgmodel.torsion_list:
        if all(torsion) < monomer_type['num_beads']:
            ...
            if torsion_index == 0:
                atom_a1, atom_a2, atom_a3, atom_a4 = cgmodel.particle_list[torsion[2]], cgmodel.particle_list[torsion[1]
                                                                                                              ], cgmodel.particle_list[torsion[0]], cgmodel.particle_list[torsion[0]]
            else:
                atom_a1, atom_a2, atom_a3, atom_a4 = cgmodel.particle_list[torsion[3]], cgmodel.particle_list[torsion[2]
                                                                                                              ], cgmodel.particle_list[torsion[1]], cgmodel.particle_list[torsion[0]]
...
def write_mm_atom_properties_txt(cgmodel, list_of_atoms_to_add):
    ...
    if not os.path.exists(mm_atom_type_sets_directory):
        os.mkdir(mm_atom_type_sets_directory)
...
def write_atom_properties_txt(cgmodel, list_of_atoms_to_add):
    ...
    if not os.path.exists(atom_type_sets_directory):
        os.mkdir(atom_type_sets_directory)
