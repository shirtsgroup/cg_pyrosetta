...
def run_mc_simulation(job):
    ...
    # Pose to be folded
    pose = cg_pyrosetta.pyrosetta.pose_from_sequence("X[CG21x2:CGLower]X[CG21x2]X[CG21x2]X[CG21x2:CGUpper]")
    change_lengths = cg_pyrosetta.CG_movers.setBondLengths(pose, {"BB1 SC1":job.sp.sc_size, "BB3 SC2":job.sp.sc_size})
