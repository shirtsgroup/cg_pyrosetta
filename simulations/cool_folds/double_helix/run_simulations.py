...
def run_mc_simulation(job):
    os.chdir(job.ws)
    cg_pyrosetta.init(extra_res_fa=["/ocean/projects/cts160011p/tfobe/foldamers/cg_pyrosetta/simulations/cool_folds/double_helix/CG10x3_1.params", "/ocean/projects/cts160011p/tfobe/foldamers/cg_pyrosetta/simulations/cool_folds/double_helix/CG10x3_2.params"])
    ...
    # Pose to be folded
    pose = cg_pyrosetta.pyrosetta.pose_from_sequence("X[CG10x3:CGLower]X[CG10x3]X[CG10x3]X[CG10x3]X[CG10x3]X[CG10x3]X[CG10x3]X[hinge]X[CG10x3]X[CG10x3]X[CG10x3]X[CG10x3]X[CG10x3]X[CG10x3]X[CG10x3:CGUpper]")
