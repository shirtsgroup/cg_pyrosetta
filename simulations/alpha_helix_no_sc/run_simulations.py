...
def set_parameters(job):
    ...
    cg_pyrosetta.change_parameters.changeAngleParameters(
        {
         'CG1 CG1 CG1' : [20 * 0.2, 105], #[k_theta, angle (degrees)]
         'CG2 CG1 CG1' : [20 * 0.2, (360 - 105)/2],
        },
...
def run_mc_simulation(job):
    ...
    # Pose to be folded
    pose = cg_pyrosetta.pyrosetta.pose_from_sequence("X[CG10x3:CGLower]X[CG10x3]X[CG10x3]X[CG10x3]X[CG10x3:CGUpper]")
