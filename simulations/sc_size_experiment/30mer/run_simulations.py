...
def run_mc_simulation(job):
    ...
    # Pose to be folded
    pose = cg_pyrosetta.pyrosetta.pose_from_sequence("X[CG11x3:CGLower]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3:CGUpper]")
