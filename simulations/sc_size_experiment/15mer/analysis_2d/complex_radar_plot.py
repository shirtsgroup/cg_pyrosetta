...
def main():
    ...
    for i, data in enumerate(all_data):
        ...
        # scale RMSD values to match sigma 
        data[2] *= 10
        data[3] *= 10
        ...
        plt.savefig(os.path.join("radar_plots", "sc_" + label + "_radar_plot.pdf"))
        plt.savefig(os.path.join("radar_plots", "sc_" + label + "_radar_plot.jpg"))
