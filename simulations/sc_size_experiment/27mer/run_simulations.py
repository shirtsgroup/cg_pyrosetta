...
def run_mc_simulation(job):
    ...
    annealer_params = cg_pyrosetta.CG_monte_carlo.\
        CGMonteCarloAnnealerParameters(n_inner = 18000,
                                       t_init = 10,
                                       anneal_rate = 0.9,
                                       n_anneals = 50,
    ...
    # Pose to be folded
    pose = cg_pyrosetta.pyrosetta.pose_from_sequence("X[CG11x3:CGLower]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3]X[CG11x3:CGUpper]")
