...
def run_mc_simulation(job):
    ...
    change_lengths = cg_pyrosetta.CG_movers.setBondLengths(pose, {"BB1 SC1":1.2778, "BB2 SC2":1.2778, "BB3 SC3":1.2778})
    ...
    print("Job: ", job.sp)
    print("Took ", run_time, " seconds to run.")
    job.document.run_time = run_time
